...
// Registry
#define JD_REGISTRY_PROFILING_COLORBASE Orange
#define JD_REGISTRY_PROFILING_BLOCK_C(text, color) JD_PROFILING_BLOCK_C(text, color)
#define JD_REGISTRY_PROFILING_NONSCOPED_BLOCK_C(text, color) JD_PROFILING_NONSCOPED_BLOCK_C(text, color)
#define JD_REGISTRY_PROFILING_END_BLOCK JD_PROFILING_END_BLOCK;
#define JD_REGISTRY_PROFILING_FUNCTION_C(color) JD_PROFILING_FUNCTION_C(color)
#define JD_REGISTRY_PROFILING_BLOCK(text, colorStage) JD_PROFILING_BLOCK(text, CONCAT_SYMBOLS(JD_REGISTRY_PROFILING_COLORBASE, colorStage))
#define JD_REGISTRY_PROFILING_NONSCOPED_BLOCK(text, colorStage) JD_PROFILING_NONSCOPED_BLOCK(text, CONCAT_SYMBOLS(JD_REGISTRY_PROFILING_COLORBASE, colorStage))
#define JD_REGISTRY_PROFILING_FUNCTION(colorStage) JD_PROFILING_FUNCTION(CONCAT_SYMBOLS(JD_REGISTRY_PROFILING_COLORBASE, colorStage))
#define JD_REGISTRY_PROFILING_VALUE(name, value) JD_PROFILING_VALUE(name, value)
#define JD_REGISTRY_PROFILING_TEXT(name, value) JD_PROFILING_TEXT(name, value)
...
// Async deleter
#ifdef JD_ASYNC_DELETER_PROFILING_ENABED
#define JD_ASYNC_DELETER_PROFILING_COLORBASE Red
#define JD_ASYNC_DELETER_PROFILING_BLOCK_C(text, color) JD_PROFILING_BLOCK_C(text, color)
#define JD_ASYNC_DELETER_PROFILING_NONSCOPED_BLOCK_C(text, color) JD_PROFILING_NONSCOPED_BLOCK_C(text, color)
#define JD_ASYNC_DELETER_PROFILING_END_BLOCK JD_PROFILING_END_BLOCK;
#define JD_ASYNC_DELETER_PROFILING_FUNCTION_C(color) JD_PROFILING_FUNCTION_C(color)
#define JD_ASYNC_DELETER_PROFILING_BLOCK(text, colorStage) JD_PROFILING_BLOCK(text, CONCAT_SYMBOLS(JD_ASYNC_DELETER_PROFILING_COLORBASE, colorStage))
#define JD_ASYNC_DELETER_PROFILING_NONSCOPED_BLOCK(text, colorStage) JD_PROFILING_NONSCOPED_BLOCK(text, CONCAT_SYMBOLS(JD_ASYNC_DELETER_PROFILING_COLORBASE, colorStage))
#define JD_ASYNC_DELETER_PROFILING_FUNCTION(colorStage) JD_PROFILING_FUNCTION(CONCAT_SYMBOLS(JD_ASYNC_DELETER_PROFILING_COLORBASE, colorStage))
#define JD_ASYNC_DELETER_PROFILING_VALUE(name, value) JD_PROFILING_VALUE(name, value)
#define JD_ASYNC_DELETER_PROFILING_TEXT(name, value) JD_PROFILING_TEXT(name, value)
#define JD_ASYNC_DELETER_PROFILING_THREAD(name) JD_PROFILING_THREAD(name)
#else
#define JD_ASYNC_DELETER_PROFILING_BLOCK_C(text, color) 
#define JD_ASYNC_DELETER_PROFILING_NONSCOPED_BLOCK_C(text, color) 
#define JD_ASYNC_DELETER_PROFILING_END_BLOCK 
#define JD_ASYNC_DELETER_PROFILING_FUNCTION_C(color) 
#define JD_ASYNC_DELETER_PROFILING_BLOCK(text, colorStage) 
#define JD_ASYNC_DELETER_PROFILING_NONSCOPED_BLOCK(text, colorStage) 
#define JD_ASYNC_DELETER_PROFILING_FUNCTION(colorStage) 
#define JD_ASYNC_DELETER_PROFILING_VALUE(name, value) 
