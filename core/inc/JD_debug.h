...
// File JDObjectLocker
#define JDFILE_OBJECT_LOCK_PROFILING_COLORBASE Orange
#define JDFILE_OBJECT_LOCK_PROFILING_BLOCK_C(text, color) JD_PROFILING_BLOCK_C(text, color)
#define JDFILE_OBJECT_LOCK_PROFILING_NONSCOPED_BLOCK_C(text, color) JD_PROFILING_NONSCOPED_BLOCK_C(text, color)
#define JDFILE_OBJECT_LOCK_PROFILING_END_BLOCK JD_PROFILING_END_BLOCK;
#define JDFILE_OBJECT_LOCK_PROFILING_FUNCTION_C(color) JD_PROFILING_FUNCTION_C(color)
#define JDFILE_OBJECT_LOCK_PROFILING_BLOCK(text, colorStage) JD_PROFILING_BLOCK(text, CONCAT_SYMBOLS(JDFILE_OBJECT_LOCK_PROFILING_COLORBASE, colorStage))
#define JDFILE_OBJECT_LOCK_PROFILING_NONSCOPED_BLOCK(text, colorStage) JD_PROFILING_NONSCOPED_BLOCK(text, CONCAT_SYMBOLS(JDFILE_OBJECT_LOCK_PROFILING_COLORBASE, colorStage))
#define JDFILE_OBJECT_LOCK_PROFILING_FUNCTION(colorStage) JD_PROFILING_FUNCTION(CONCAT_SYMBOLS(JDFILE_OBJECT_LOCK_PROFILING_COLORBASE, colorStage))
#define JDFILE_OBJECT_LOCK_PROFILING_VALUE(name, value) JD_PROFILING_VALUE(name, value)
#define JDFILE_OBJECT_LOCK_PROFILING_TEXT(name, value) JD_PROFILING_TEXT(name, value)


// File JDUniqueMutex
#define JDFILE_MUTEX_PROFILING_COLORBASE DeepPurple
#define JDFILE_MUTEX_PROFILING_BLOCK_C(text, color) JD_PROFILING_BLOCK_C(text, color)
#define JDFILE_MUTEX_PROFILING_NONSCOPED_BLOCK_C(text, color) JD_PROFILING_NONSCOPED_BLOCK_C(text, color)
#define JDFILE_MUTEX_PROFILING_END_BLOCK JD_PROFILING_END_BLOCK;
#define JDFILE_MUTEX_PROFILING_FUNCTION_C(color) JD_PROFILING_FUNCTION_C(color)
#define JDFILE_MUTEX_PROFILING_BLOCK(text, colorStage) JD_PROFILING_BLOCK(text, CONCAT_SYMBOLS(JDFILE_MUTEX_PROFILING_COLORBASE, colorStage))
#define JDFILE_MUTEX_PROFILING_NONSCOPED_BLOCK(text, colorStage) JD_PROFILING_NONSCOPED_BLOCK(text, CONCAT_SYMBOLS(JDFILE_MUTEX_PROFILING_COLORBASE, colorStage))
#define JDFILE_MUTEX_PROFILING_FUNCTION(colorStage) JD_PROFILING_FUNCTION(CONCAT_SYMBOLS(JDFILE_MUTEX_PROFILING_COLORBASE, colorStage))
#define JDFILE_MUTEX_PROFILING_VALUE(name, value) JD_PROFILING_VALUE(name, value)
#define JDFILE_MUTEX_PROFILING_TEXT(name, value) JD_PROFILING_TEXT(name, value)
